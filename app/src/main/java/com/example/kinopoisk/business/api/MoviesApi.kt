...
interface MoviesApi {
    ...
    @Headers("X-API-KEY: YKEA3FF-QPT4Z39-MP0678S-HG5Q2QF",
        "Content-Type: application/json")
    @GET("movie?field=rating.kp&search=7-10&field=year&search=1950-2023&field=typeNumber&search=1&sortField=votes.imdb&sortType=-1&limit=15")
    fun getMoviesPopular(
    ) : Observable<TEST>

    @Headers("X-API-KEY: YKEA3FF-QPT4Z39-MP0678S-HG5Q2QF",
        "Content-Type: application/json")
    @GET("movie?field=rating.kp&search=1-10&field=year&search=2023&field=typeNumber&search=1&sortField=year&sortType=-1&sortField=votes.imdb&sortType=-1&limit=15")
